...
public class UseTween {
    ...
    public static class LoopScaleAnim extends UseAnimation {
        ...
        @Override
        public float getScale() {
            return TweenUtil.punch(GUITweenConfig.hotbar.useStrength.get().floatValue(), 1, tween.tick / 4f);
        }
    }
    ...
    public static class ContinuesScaleAnim extends UseAnimation {
        ...
        @Override
        public float getScale() {
            return 1 + Mth.sin(tween.tick) * GUITweenConfig.hotbar.useStrength.get().floatValue();
        }
    }
}
