...
public class ContainerItemTween {
    ...
    public Tuple<Integer, Integer> getMoveTweenValue(float fromX, float fromY, float toX, float toY, Single single, int to, AbstractContainerMenu menu) {
        ...
        float moveDuration = GUITweenConfig.moveDuration();
        Ease moveEase = GUITweenConfig.moveEase();
    ...
    public int getPickupCount() {
        return pickupTweenMap.size();
    }

    public int getQuickCraftCount() {
        return quickCraftTweenMap.size();
    }
    ...
    public void addFinishTween(Slot slot) {
        ...
        if (!finishTween.containsKey(slot)) {
            ...
            PlayGuiSoundEvent.post(new PlayGuiSoundEvent(PlayGuiSoundEvent.SoundType.MOVE_FINISH));
        }
    }
    ...
    public Float getFinishScale(Slot slot) {
        ...
        float punchStrength = GUITweenConfig.finishPunchStrength();
        float finishDuration = GUITweenConfig.finishDuration();
    ...
    public void addPickupTween(Slot slot) {
        ...
        PlayGuiSoundEvent.post(new PlayGuiSoundEvent(PlayGuiSoundEvent.SoundType.PICK_UP));
    }
    ...
    public Float getPickupScale(Slot slot) {
        ...
        float pickupDuration = GUITweenConfig.pickupDuration();
        Ease pickupEase = GUITweenConfig.pickupEase();

        float scale = TweenUtil.tween(GUITweenConfig.clickItemScale(), 1, tick / pickupDuration, pickupEase);
    ...
    public Float getQuickCraftScale(Slot slot) {
        ...
        float quickCraftDuration = GUITweenConfig.quickCraftDuration();
